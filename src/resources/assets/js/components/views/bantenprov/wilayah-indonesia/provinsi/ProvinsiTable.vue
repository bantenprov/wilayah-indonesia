      ...
      <template slot="actions" slot-scope="props">
        <div class="table-button-container">
          <button href="" class="btn btn-success btn-sm mr-1 mb-1" @click="goto(props.rowData)">
            <span class="fa fa-pencil"></span> Lihat Kabupaten
          </button>
...
export default {
  ...
  methods: {
    ...
    editRow(rowData){
		this.$router.push("provinsi/"+rowData.id+"/form");
    },
	deleteRow(rowData){
		Vue.swal({
		  title: 'Are you sure?',
		  ...
		  cancelButtonText: 'Cancel'
			...
			console.log(result);
			if (result.value) {
				axios.post('/wilayah-indonesia/provinsi/delete',{
					id : rowData.id
				})
