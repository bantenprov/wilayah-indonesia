    ...
    <vuetable ref="vuetable"
      ...
      <template slot="actions" slot-scope="props">
        <div class="table-button-container">
          <button class="btn btn-success btn-sm mr-1 mb-1" @click="goto(props.rowData)">
            <span class="fa fa-pencil"></span> Lihat Desa
          </button>
...
export default {
  ...
  methods: {
	...
	goto: function(rawData){
		this.$router.push(rawData.province_name+'/'+rawData.city_name+'/'+rawData.district_name);
	}
  },
  events: {
